...
BigZombieBoss::BigZombieBoss(sf::Texture &texture, sf::Vector2f startPos,
                             std::vector<Projectile> &projs,
                             ResourceManager &res, int playerLevel)
...
void BigZombieBoss::update(float dt, sf::Vector2f playerPos) {
